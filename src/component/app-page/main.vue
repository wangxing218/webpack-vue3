<template>
  <ul class="ui-page">
    ...
    <li v-show="pagerStart > 2" class="page-more" @click="go(pageIndex - pagerCount + 1)">..</li>
    <li v-for="item in pager" :key="item" :class="{ active: pageIndex === item }" @click="go(item)">
      {{ item }}
    </li>
    <li v-show="pagerEnd === pages - 1" @click="go(pagerEnd)">
      {{ pagerEnd }}
    </li>
    <li v-show="pagerEnd < pages - 1" class="page-more" @click="go(pageIndex + pagerCount - 1)">
      ..
    </li>
    <li v-if="pages > 1" :class="{ active: pageIndex === pages }" @click="end">
      {{ pages }}
    </li>
